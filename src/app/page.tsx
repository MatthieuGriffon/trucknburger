...
export default function Home() {
  return (
    <section>
      <div className="relative h-[50vh] sm:h-[64.5vh] md:h-[40vh] lg:h-[85vh]">
        <Image
          priority
          placeholder="blur"
          quality={100}
      ...
      <div className="absolute top-0 left-0 w-full h-full flex items-center justify-center p-4 md:left-10 md:w-1/2 z-10 md:h-[50rem]">
        <div className="bg-black bg-opacity-60 p-4 rounded text-center text-white">
          <h1 className="text-xl md:text-1xl">Bienvenue chez TrucknBurger !</h1>
